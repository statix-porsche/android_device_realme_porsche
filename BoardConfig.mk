...
BOARD_OPLUS_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor vendor_dlkm
BOARD_OPLUS_DYNAMIC_PARTITIONS_SIZE := 11186208768 # (BOARD_SUPER_PARTITION_SIZE - 4 MiB)
BOARD_SUPER_PARTITION_GROUPS := oplus_dynamic_partitions
BOARD_FLASH_BLOCK_SIZE := 262144 # (BOARD_KERNEL_PAGESIZE * 64)

$(foreach p, $(call to-upper, $(BOARD_OPLUS_DYNAMIC_PARTITIONS_PARTITION_LIST)), \
